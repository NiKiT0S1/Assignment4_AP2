...
const file_user_proto_rawDesc = "" +
	...
	"\busername\x18\x02 \x01(\tR\busername2\xab\x01\n" +
	"\vUserService\x125\n" +
	...
	"\n" +
	"GetProfile\x12\f.user.UserID\x1a\x12.user.UserResponseB\x1bZ\x19apiGateway/internal/protob\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	3, // 4: user.UserService.Authenticate:output_type -> user.UserResponse
